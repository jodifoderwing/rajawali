<x-filament-panels::page>
    ...
    <script>
                ...
                source: new ol.source.Vector({
                    ...
                    url: function() {
                        const urlParams = new URLSearchParams({
                            ...
                            version: '1.0.0',
                            request: 'GetFeature',
                            typeName: 'Simtaka:tanahkasultanan',
                            outputFormat: 'application/json',
                            srsname: 'EPSG:4326',
                            cql_filter: kalkelId ? `kalkel_id=${kalkelId}` : '1=0',
                        });
        ...
        function setupMapEventListeners() {
            ...
            map.on("singleclick", function(evt) {
                const feature = map.forEachFeatureAtPixel(evt.pixel, function (feature, layer) {
                    if (layer === tanahKasultananVector) {
                        return feature;
                    }
                    return null;
                });
        ...
        function loadData(kalkelId, spinner, tableSpinner, noDataMessage, dataTable, locationHeader) {
            ...
            tanahKasultananVector.getSource().once('featuresloadend', function(event) {
        ...
        function updateTable(features) {
            ...
            if (features.length > 0) {
                ...
                dataTable.style.display = 'none';
                noDataMessage.style.display = 'block';
                noDataMessage.innerText = 'Tidak ada data bidang tanah Kasultanan di kalurahan ini.';
            }
        }
        ...
        function attachTableRowListeners() {
            ...
            newTable.addEventListener('click', function(evt) {
                ...
                if (clickedRow && tanahKasultananVector) {
                    const featureId = clickedRow.getAttribute('data-feature-id');
                    const feature = tanahKasultananVector.getSource().getFeatureById(featureId);
                    updateHighlight(feature);
